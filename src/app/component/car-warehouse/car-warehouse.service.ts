...
@Injectable()
export class CarWarehouseApiService extends DeleteEngineService {
    ...
    public override async delete(id: string): Promise<void> {
        console.info(id, '------------------- resource id', `API URl: http://localhost:3000/car/warehouse/delete/${id}`);

        try {
            // you may call a dialog service here to confirm the deletion before calling the delete API

            await firstValueFrom(this.httpClient.delete(`http://localhost:3000/car/warehouse/delete/${id}`));
